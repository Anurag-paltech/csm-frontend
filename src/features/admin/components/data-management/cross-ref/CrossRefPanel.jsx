...
/**
 * Admin → Data Management → Cross Ref. Read-only history of SRT code
 * changes (`GET /lookups/srt-changes`); the only way to add to it is
      ...
      <div className="mb-3 flex flex-wrap items-center justify-between gap-2.5">
        <div className="relative">
          ...
          <Input
            ...
            placeholder="Search SRT code or reason"
            aria-label="Search SRT code changes"
            className="w-64 pl-8"
          />
        </div>

        <Button onClick={() => setUploadOpen(true)}>Upload Excel</Button>
      </div>
